<template>
  <Sidebar collapsible="icon" class="hidden md:flex">
    <SidebarHeader>
      <div class="p-4">
        <h2 class="text-lg font-semibold">Пошук міст</h2>
      </div>
    </SidebarHeader>

    <SidebarContent>
      <div v-if="!selectedLocation" class="p-4">
        <SidebarInput
          v-model="searchQuery"
          placeholder="Пошук населених пунктів..."
          class="w-full"
        />
      </div>
